...
const s_stylePath = './comments_page.css';
const s_formId = '1FAIpQLSfJPlb8yC0xGdbe6eRisNdkRk5HiXAMdQ8La3VUHWs5wjpnSg';
const s_nameId = '39550401';
const s_websiteId = '1799048189';
const s_textId = '1643440628';
const s_pageId = '126072856';
const s_replyId = '1753558053';
const s_sheetId = '1FjrXU2yuBkj6izYMCjtXNCPL3FCC_-TV41tBe0yQ-DA';
...
const s_widgetTitle = 'Leave a review!';
const s_nameFieldLabel = 'Name';
const s_websiteFieldLabel = 'Social (optional) @';
const s_textFieldLabel = '';
const s_submitButtonLabel = 'Submit';
const s_loadingText = 'Loading reviews...';
const s_noCommentsText = 'No reviews yet!';
const s_closedCommentsText = 'Review form is closed temporarily!';
